<div class="min-h-screen bg-black text-white flex items-center justify-center" style="overflow-x:hidden" x-data="carouselFilter()">
  <div class="container grid grid-cols-1">
    <div class="flex py-12 justify-center">
      <a class="px-2 text-lg uppercase font-bold tracking-widest hover:text-white" :class="{ 'text-gray-800': active != 1 }" href="#" @click.prevent="changeActive(0)">Featured Blogs</a>
      <!-- <a class="px-2 text-lg uppercase font-bold tracking-widest hover:text-white" :class="{ 'text-gray-700': active != 1 }" href="#" @click.prevent="changeActive(1)">Life Practiv</a> -->
    </div>
    ...
    >
      <div class="grid grid-cols-1 grid-rows-1" x-data="carousel()" x-init="init()">
        <div class="col-start-1 row-start-1 relative z-20 flex items-center justify-center pointer-events-none">
          ...
          <h1 class="absolute text-5xl text-center uppercase font-black tracking-widest"
              x-show="active == 0"
              x-transition:enter="transition ease-out duration-300"
